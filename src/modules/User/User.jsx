...
function User() {
    ...
    const renderBookingHistory = () => {
        return (userInfo?.thongTinDatVe?.map((ticket, index) => {
            return (
                <div className={`col-6 mt-2 ${styles.column}`} key={index}>
                    <div className="d-flex px-2">
                        ...
                        <div className="col-9 ps-3">
                            ...
                            <h5 className="text-success mb-0 mt-1 fw-bold">{ticket.danhSachGhe[0].tenHeThongRap}</h5>
    ...
    return (
        <div className={`col-md-12 col-lg-10 ${styles.box}`}>
